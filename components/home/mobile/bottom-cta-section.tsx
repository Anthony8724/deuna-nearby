...
export function BottomCTASection() {
  const { openTransfer, openQrPayment } = useWalletDemo();
    ...
    >
      <div className="flex gap-3">
        ...
        <motion.button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#5D21D0] p-4 text-sm font-semibold text-white shadow-[0_4px_16px_rgba(93,33,208,0.28)]"
        >
